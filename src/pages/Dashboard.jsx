  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <div className="stat-card border-l-4 border-blue-500 hover:border-blue-600 animate-fade-in">
        ...
        <div className="stat-card border-l-4 border-green-500 hover:border-green-600 animate-fade-in" style={{ animationDelay: '0.1s' }}>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-semibold text-gray-600 uppercase tracking-wide">High Viability</p>
              <p className="text-4xl font-bold text-gray-900 mt-3">{stats.highViability}</p>
        ...
        <div className="stat-card border-l-4 border-yellow-500 hover:border-yellow-600 animate-fade-in" style={{ animationDelay: '0.2s' }}>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Pending Review</p>
              <p className="text-4xl font-bold text-gray-900 mt-3">{stats.pendingReview}</p>
        ...
        <div className="stat-card border-l-4 border-purple-500 hover:border-purple-600 animate-fade-in" style={{ animationDelay: '0.3s' }}>
          <div className="flex items-center justify-between">
            <div className="flex-1">
              <p className="text-sm font-semibold text-gray-600 uppercase tracking-wide">Avg. Score</p>
              <p className="text-4xl font-bold text-gray-900 mt-3">{stats.avgScore}</p>
